...
const MonitorScreen = (props) => {
    ...
    const [frameRate, setFrameRate] = useState(1000 - props.frameRate);
    const [active, setActive] = useState(false);
    ...
    return (
        <>
            ...
            <TexturedBox position={[3, 0.75, 0]} size={[2, 0.5, 0.25]} color='#F2CF63' image={[imgTop, imgTopIn]} scale={-0.1} active={active} sync={sync} />
            <TexturedBox position={[3, 0, 0]} size={[2, 0.5, 0.25]} color='#F2CF63' image={[imgMiddle, imgMiddle]} />
            <TexturedBox position={[3, -0.75, 0]} size={[2, 0.5, 0.25]} color='#F2CF63' image={[imgBottom, imgBottomIn]} scale={0.1} active={active} sync={sync} />
        </>
    )
}
